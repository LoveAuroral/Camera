package auroral.widget.view.camera.base;
...
import auroral.widget.view.camera.util.AngleUtils;
import auroral.widget.view.camera.util.CameraParamUtils;
import auroral.widget.view.camera.util.CheckPermission;
import auroral.widget.view.camera.util.DeviceUtils;
