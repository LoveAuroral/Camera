package auroral.widget.view.camera.view;
...
import auroral.widget.view.camera.base.CameraInterface;
import auroral.widget.view.camera.base.ICameraView;
import auroral.widget.view.camera.listener.CameraListener;
import auroral.widget.view.camera.listener.CaptureListener;
import auroral.widget.view.camera.listener.ClickListener;
import auroral.widget.view.camera.listener.ErrorListener;
import auroral.widget.view.camera.listener.TypeListener;
import auroral.widget.view.camera.state.CameraMachine;
import auroral.widget.view.camera.util.FileUtils;
import auroral.widget.view.camera.util.ScreenUtils;
