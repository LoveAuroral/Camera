package com.auroral.camera.base;
...
import com.auroral.camera.util.AngleUtils;
import com.auroral.camera.util.CameraParamUtils;
import com.auroral.camera.util.CheckPermission;
import com.auroral.camera.util.DeviceUtils;
...
public class CameraInterface implements Camera.PreviewCallback {
    ...
    public void setSwitchView(ImageView mSwitchView, ImageView mFlashLamp) {
        ...
        if (mSwitchView != null) {
            cameraAngle = CameraParamUtils.getInstance().getCameraDisplayOrientation(mSwitchView.getContext(),
                    SELECTED_CAMERA);
        }
    }
    ...
    private SensorEventListener sensorEventListener = new SensorEventListener() {
        public void onSensorChanged(SensorEvent event) {
            ...
            angle = AngleUtils.getSensorAngle(values[0], values[1]);
            rotationAnimation();
        }
...
//                destroyCameraInterface();
    ...
    public void startRecord(Surface surface, float screenProp, ErrorCallback callback) {
        ...
        if (mParams.getSupportedVideoSizes() == null) {
            videoSize = CameraParamUtils.getInstance().getPreviewSize(mParams.getSupportedPreviewSizes(), 600,
                    screenProp);
        } else {
            videoSize = CameraParamUtils.getInstance().getPreviewSize(mParams.getSupportedVideoSizes(), 600,
                    screenProp);
        }
        ...
        videoFileName = System.currentTimeMillis() + "" + System.nanoTime() + ".mp4";
